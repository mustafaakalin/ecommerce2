...
export const createProduct = (
    ...
    return {
        ...
        discount_type: faker.helpers.maybe(() => 
            faker.helpers.arrayElement(Object.values(DiscountType)), 
            { probability: 0.3 }
        ),
        discount_value: faker.helpers.maybe(() => 
            faker.number.float({ min: 5, max: price * 0.5, fractionDigits: 2 })
        ),
